...
public class BlockType
{
	...
	public BlockType(String hash, String version, String prev_block, String mrkl_root, Date time, long bits, long nonce, int n_tx, long size,
	...
	public void parseBlock(String blockString) throws JSONException
	{
		...
		for (int i = 0; i < transactionsArray.length(); i++)
		{
			...
			for (int k = 0; k < outgoingTransactionsArray.length(); k++)
			{
				...
				outgoing.setValue(outgoingJSON.getString(VALUE));
