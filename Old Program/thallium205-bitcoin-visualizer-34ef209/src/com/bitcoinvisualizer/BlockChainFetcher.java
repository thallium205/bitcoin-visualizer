...
public class BlockChainFetcher
{
	...
	String rawBlockAddress;
	String latestHashAddress;
	 ...
	 *            address from
	 */
	BlockChainFetcher(String rawBlockAddress, String latestHashAddress)
	{
		this.rawBlockAddress = rawBlockAddress;
		this.latestHashAddress = latestHashAddress;
	}
