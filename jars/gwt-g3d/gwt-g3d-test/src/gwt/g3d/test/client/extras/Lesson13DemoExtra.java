...
/**
 * Extra widget for lesson 13 demo.
 */
public class Lesson13DemoExtra extends Composite {

  interface MyUiBinder extends UiBinder<Widget, Lesson13DemoExtra> {}
  private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

  @UiField CheckBox chkLighting, chkPerFragment, chkTextures;
  ...
  /**
   * Gets whether to use per-fragment shading or per-vertex lighting.
   * True if per-fragment shading is to be used.
   */
  public boolean isPerFragment() {
  	return chkPerFragment.getValue();
  }
  
  /**
   * Gets whether to use textures.
   */
  public boolean isTextures() {
  	return chkTextures.getValue();
  }
