...
/**
 * Extra widget for lesson 8 demo.
 */
public class Lesson8DemoExtra extends Composite {

  interface MyUiBinder extends UiBinder<Widget, Lesson8DemoExtra> {}
  private static MyUiBinder uiBinder = GWT.create(MyUiBinder.class);

  @UiField CheckBox chkBlending;
  @UiField CheckBox chkLighting;
  
  @UiField TextBox txtAlpha;
  ...
  public boolean isBlending() {
  	return chkBlending.getValue();
  }
  
  /**
   * Gets the alpha level.
   */
  public float getAlpha() {
  	return parse(txtAlpha);
  }
