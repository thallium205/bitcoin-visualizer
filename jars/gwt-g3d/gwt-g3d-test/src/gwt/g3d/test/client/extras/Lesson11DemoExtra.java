...
/**
 * Extra widget for lesson 11 demo.
 */
public class Lesson11DemoExtra extends Composite {

  interface MyUiBinder extends UiBinder<Widget, Lesson11DemoExtra> {}
