...
import gwt.g3d.test.client.extras.Lesson7DemoExtra;
...
/**
 * GWT-port for the lesson 7.
 * 
 * @author hao1300@gmail.com
 */
public class Lesson7Demo extends AbstractLessonDemo {
	private static final int LESSON_NUMBER = 7;
	private final Matrix3f nMatrix = new Matrix3f(); 
	private Texture2D crateTexture;
	private final Lesson7DemoExtra extraWidget = new Lesson7DemoExtra();
