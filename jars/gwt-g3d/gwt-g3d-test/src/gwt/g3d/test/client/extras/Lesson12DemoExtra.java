...
/**
 * Extra widget for lesson 12 demo.
 */
public class Lesson12DemoExtra extends Composite {

  interface MyUiBinder extends UiBinder<Widget, Lesson12DemoExtra> {}
