...
/**
 * A {@link WebGLUnsignedIntArray} represents an array of 32-bit unsigned 
 * integer values.
 * A {@link WebGLUnsignedIntArray} has an element size of 4 bytes.
 * 
 * @author hao1300@gmail.com
 */
@Deprecated
public class WebGLUnsignedIntArray extends WebGLArray {
	public static final int BYTES_PER_ELEMENT = 4;
	
	protected WebGLUnsignedIntArray() {

	}
	
	/**
	 * Create a new {@link WebGLUnsignedIntArray} object of the given length with 
	 * a new underlying {@link WebGLArrayBuffer} large enough to hold length 
	 * elements of the specific type. Data in the buffer is initialized to 0.
	 * 
	 * @param length
	 */
	public static native WebGLUnsignedIntArray createArray(int length) /*-{
		return new $wnd.WebGLUnsignedIntArray(length);
	}-*/;
	
	/**
	 * Create a new {@link WebGLUnsignedIntArray} object with a new underlying 
	 * {@link WebGLArrayBuffer} large enough to hold the given data, then copy 
	 * the passed data into the buffer.
	 * 
	 * @param array
	 */
	public static native WebGLUnsignedIntArray createArray(
			WebGLUnsignedIntArray array) /*-{
		return new $wnd.WebGLUnsignedIntArray(array);
	}-*/;
	 ...
	 * @param array
	 */
	public static WebGLUnsignedIntArray createArray(int... array) {
		WebGLUnsignedIntArray newArray = createArray(array.length);
	 ...
	 */
	public static native WebGLUnsignedIntArray createArray(JavaScriptObject array) /*-{
		return new $wnd.WebGLUnsignedIntArray(array);
	}-*/;
	
	/**
	 * Create a new {@link WebGLUnsignedIntArray} object using the passed 
	 ...
	 * 				{@link WebGLUnsignedIntArray} will reference
	 */
	public static native WebGLUnsignedIntArray createArray(
			WebGLArrayBuffer buffer, int byteOffset, int length) /*-{
		return new $wnd.WebGLUnsignedIntArray(buffer, byteOffset, length);
	}-*/;
