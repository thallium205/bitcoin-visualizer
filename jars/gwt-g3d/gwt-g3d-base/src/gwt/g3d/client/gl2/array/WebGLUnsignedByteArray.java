...
/**
 * A {@link WebGLUnsignedByteArray} represents an array of 8-bit unsigned 
 * integer values.
 * A {@link WebGLUnsignedByteArray} has an element size of 1 bytes.
 * 
 * @author hao1300@gmail.com
 */
@Deprecated
public class WebGLUnsignedByteArray extends WebGLArray {
	...
	/**
	 * Create a new {@link WebGLUnsignedByteArray} object of the given length 
	 ...
	 * @param length
	 */
	public static native WebGLUnsignedByteArray createArray(int length) /*-{
		return new $wnd.WebGLUnsignedByteArray(length);
	}-*/;
	
	/**
	 * Create a new {@link WebGLUnsignedByteArray} object with a new underlying 
	 * {@link WebGLArrayBuffer} large enough to hold the given data, then copy 
	 * the passed data into the buffer.
	 * 
	 * @param array
	 */
	public static native WebGLUnsignedByteArray createArray(
			WebGLUnsignedByteArray array) /*-{
		return new $wnd.WebGLUnsignedByteArray(array);
	}-*/;
	 ...
	 * @param array
	 */
	public static WebGLUnsignedByteArray createArray(int... array) {
		WebGLUnsignedByteArray newArray = createArray(array.length);
	 ...
	 */
	public static native WebGLUnsignedByteArray createArray(JavaScriptObject array) /*-{
		return new $wnd.WebGLUnsignedByteArray(array);
	}-*/;
	
	/**
	 * Create a new {@link WebGLUnsignedByteArray} object using the passed 
	 ...
	 * 				{@link WebGLUnsignedByteArray} will reference
	 */
	public static native WebGLUnsignedByteArray createArray(
			WebGLArrayBuffer buffer, int byteOffset, int length) /*-{
		return new $wnd.WebGLUnsignedByteArray(buffer, byteOffset, length);
	}-*/;
