...
public enum DrawElementsType {
  ...
  private static Map<Integer, DrawElementsType> dataTypeMap;
   ...
   * @param dataType
   */
  public static DrawElementsType parseDataType(int dataType) {
  	if (dataTypeMap == null) {
  		dataTypeMap = new HashMap<Integer, DrawElementsType>();
  		for (DrawElementsType v : values()) {
