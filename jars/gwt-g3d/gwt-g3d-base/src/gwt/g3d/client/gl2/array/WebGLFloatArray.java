...
/**
 * A {@link WebGLFloatArray} represents an array of 32-bit floating point values.
 * A {@link WebGLFloatArray} has an element size of 4 bytes.
 * 
 * @author hao1300@gmail.com
 */
@Deprecated
public class WebGLFloatArray extends WebGLArray {
	...
	/**
	 * Create a new {@link WebGLFloatArray} object of the given length with a new 
	 ...
	 * @param length
	 */
	public static native WebGLFloatArray createArray(int length) /*-{
		return new $wnd.WebGLFloatArray(length);
	}-*/;
	
	/**
	 * Create a new {@link WebGLFloatArray} object with a new underlying 
	 * {@link WebGLArrayBuffer} large enough to hold the given data, then copy 
	 * the passed data into the buffer.
	 * 
	 * @param array
	 */
	public static native WebGLFloatArray createArray(WebGLFloatArray array) /*-{
		return new $wnd.WebGLFloatArray(array);
	}-*/;
	 ...
	 * @param array
	 */
	public static WebGLFloatArray createArray(float... array) {
		if (GWT.isScript()) {
			return createArrayCompiled(array);
		}
		return createArray(JsArrayUtils.toJsArrayNumber(array));
	}
	
	private static native WebGLFloatArray createArrayCompiled(float[] array) /*-{
		return new $wnd.WebGLFloatArray(array);
	}-*/;
	 ...
	 */
	public static native WebGLFloatArray createArray(JsArrayNumber array) /*-{
		return new $wnd.WebGLFloatArray(array);
	}-*/;
	
	/**
	 * Create a new {@link WebGLFloatArray} object using the passed 
	 ...
	 * 				{@link WebGLFloatArray} will reference
	 */
	public static native WebGLFloatArray createArray(WebGLArrayBuffer buffer,
			int byteOffset, int length) /*-{
		return new $wnd.WebGLFloatArray(buffer, byteOffset, length);
	}-*/;
